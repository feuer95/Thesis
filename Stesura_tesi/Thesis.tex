...
\begin{table}[]\caption{\label{table:ONB}Numerical results obtained by the codes.}
	...
	\end{tabular}
\end{table}
\begin{figure}\caption{\label{figure:onb}Execution of the IPMs tubular production LP model:}
...
\end{figure}
\begin{figure}\caption{\label{figure:onb2}Execution of predictor-corrector IPMs tubular production LP model:}
