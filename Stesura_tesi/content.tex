...
% PRIMA SLIDE
%
\begin{frame}[t]{\textsc{Introduzione al problema LP}}
\textbf{Modello LP standard: $A \in \mathbb{R}^{m,n}, c\in \mathbb{R}^{n}, b \in \mathbb{R}^{m}$}\\
\begin{equation*}
\begin{split}
\min\;&c^{T}x\\
...
\pause
\text{L'insieme dei punti ammissibili:}\\
\begin{equation*}
