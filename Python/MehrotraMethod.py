...
@author: Elena
"""
from starting_point import sp       # Function to find the initial infeasible point MIP
from starting_point2 import sp2     # Function to find the initial infeasible point STP1
...
from cent_meas import cent_meas     # Plot duality gap and centering deviation
...
Input data: np.arrays of matrix A, cost vector c, vector RHS b of the LP
            c_form: canonical form -> default 0
            w: tollerance -> default 10^(-8)
            max_it: no max iterations -> default 500
            ip: starting point -> default 0
